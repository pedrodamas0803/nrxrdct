...
and the result is written as two files in a shared tmp directory:

    <tmp_dir>/scan_XXXX.npy        — sinogram, shape (n_frames, n_points)
    <tmp_dir>/scan_XXXX.meta.json  — scan attributes (dty, fpico6 stats, …)

No HDF5 file is touched during integration, eliminating all concurrent-write
