"""
Visualization functions for XRD-CT data: CAKE integration plots, interactive
3D volume visualization using napari, and Jupyter slice viewers with profiles.
...
-------------------------
    ...
    from nrxrdct.visualization import visualize_slices_with_profile_jupyter
