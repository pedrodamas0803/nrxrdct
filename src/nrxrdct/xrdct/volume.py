"""
Reconstructed XRD-CT volume container and per-voxel analysis helpers.

:class:`ReconstructedVolume` manages per-voxel .xy file I/O and
parallelised GSAS-II Rietveld refinement on a reconstructed 3-D volume.
"""
...
def _get_all_maps_ii_jj(args: tuple) -> Tuple[float, ...]:
    """Return ``(rwp, chi2, a, b, c, size, mustrain, scale)`` for voxel ``(ii, jj)``.
